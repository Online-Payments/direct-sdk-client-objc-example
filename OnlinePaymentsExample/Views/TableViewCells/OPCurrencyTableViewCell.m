...
@interface OPCurrencyTableViewCell ()

@property (strong, nonatomic) UILabel *separatorlabel;
@property (strong, nonatomic) UILabel *currencyCodeLabel;
@property (strong, nonatomic) OPIntegerTextField *integerTextField;
@property (strong, nonatomic) OPFractionalTextField *fractionalTextField;

@end

@implementation OPCurrencyTableViewCell
